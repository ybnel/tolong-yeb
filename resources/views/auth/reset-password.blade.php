    ...
    <div class="px-4 sm:px-10 md:px-40 flex flex-1 justify-center py-5">
        <div class="layout-content-container flex flex-col w-full sm:w-[512px] py-5 max-w-[960px] flex-1">
            <div class="px-4 text-center">
                <h2 class="text-white tracking-light text-[28px] font-bold leading-tight pb-3 pt-5">Reset Your Password</h2>
            </div>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3 mx-auto">
                    <label for="password" class="flex flex-col min-w-40 flex-1">
                      <p class="text-white text-base font-medium leading-normal pb-2">New Password</p>
                      <input
                ...
                <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3 mx-auto">
                    <label for="password_confirmation" class="flex flex-col min-w-40 flex-1">
                      <p class="text-white text-base font-medium leading-normal pb-2">Confirm New Password</p>
                      <input
                ...
                <div class="flex px-4 py-3 mt-4 max-w-[480px] mx-auto">
                    ...
                    >
                      <span class="truncate">{{ __('Reset Password') }}</span>
                    </button>
                </div>
            </form>
        </div>
